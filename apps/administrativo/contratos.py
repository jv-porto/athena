...
def contrato_educacional(request, variaveis_dict, estudante_contratante):
    ...
    if (variaveis_dict["percentual_desconto_curso"] != '0%') and (variaveis_dict["percentual_desconto_curso"] != '0,00%'):
        paragrafo_3 = paragrafo_3 + f' Ficou acordado, entre as partes, um desconto de {variaveis_dict["percentual_desconto_curso"]} no valor do curso.'
