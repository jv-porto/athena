...
class Email(models.Model):
    ...
    mensagem_html = models.CharField(max_length=100, blank=True)
    variaveis = models.JSONField(blank=True, default=dict)
    anexos = models.CharField(max_length=200, blank=True)
