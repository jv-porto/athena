...
def usuarios_permissoes(request):
    ...
    if 'search' in request.GET:
        ...
        data = {'permissoes': requests.get(f'https://athena.thrucode.com.br/api/escola/{escola}/usuarios_permissoes/?is_active=true&search={search}', cookies=cookies, headers=headers).json()}
    else:
...
def ano_academico(request):
    ...
    if 'search' in request.GET:
        search = request.GET['search']
        data = {'ano_academico': requests.get(f'https://athena.thrucode.com.br/api/escola/{escola}/anos_academicos/?deleted=false&search={search}', cookies=cookies, headers=headers).json()}
    else:
