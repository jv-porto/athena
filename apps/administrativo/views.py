...
#        email_request = requests.post('http://127.0.0.1:8000/api/email/', json=email_data, cookies=cookies, headers=headers)
    ...
    if request.method == 'GET':
        ...
        if request.POST['type'] == 'Educacional':
            ...
            variaveis_dict = {
                ...
                'contratante_data_nascimento': contratante.data_nascimento.strftime('%d/%m/%Y'),
                ...
                'estudante_data_nascimento': estudante.data_nascimento.strftime('%d/%m/%Y'),
