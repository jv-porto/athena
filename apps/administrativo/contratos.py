...
def contrato_educacional(request, variaveis_dict, estudante_contratante):
    ...
    if variaveis_dict['curso_descricao'] == 'Engaja':
        paragrafo_1.append(f' SEGUNDA A SEXTA, das 9h às 19h, compreendendo, neste período, atividades, como: aulas, plantões, simulados, orientação pedagógica individual e coletiva, assembleias, atividades socioemocionais e o curso de políticas públicas.')
    elif variaveis_dict['curso_descricao'] == 'Engaja Online':
        paragrafo_1.append(f' SEGUNDA A SEXTA, das 9h às 19h, compreendendo, neste período, atividades online, como: aulas, plantões, simulados, orientação pedagógica coletiva, atividades socioemocionais e o curso de políticas públicas.')
    elif variaveis_dict['curso_descricao'] == 'Conexão':
        paragrafo_1.append(f' SEGUNDA A QUINTA, das 19h às 22h40min, compreendendo, neste período, aulas, plantões, simulados, orientação pedagógica coletiva, assembleias e atividades do contraturno (atividades socioemocionais e o curso de políticas públicas) a depender da disponibilidade do aluno.')
    elif variaveis_dict['curso_descricao'] == 'Conexão Online':
        paragrafo_1.append(f' SEGUNDA A SEXTA, das 19h às 22h40min, compreendendo, neste período, atividades online, como: aulas, plantões, simulados e orientação psicopedagógica.')
